...
def define_lines():
    ...
    return collections.OrderedDict([
        ...
        ('H-beta 4862', ['H' + beta, 4862.68e-4]),
        ('[OIII] 4960', ['[OIII]', 4960.30e-4]),
        ('[OIII] 5008', ['[OIII]', 5008.24e-4]),
        ('[NI] 5199', ['[NI]', 5199e-4]),
        ('[NII] 5755', ['[NII]', 5754.6e-4]),
        ('HeI 5877', ['HeI', 5877.29e-4]),
        ('[OI] 6302', ['[OI]', 6302.05e-4]),
        ('[NII] 6549', ['[NII]', 6549.85e-4]),
        ('H-alpha 6564', ['H' + alpha, 6564.61e-4]),
        ('[NII] 6585', ['[NII]', 6585.28e-4]),
        ('SII 6718', ['SII', 6718.29e-4]),
        ('SII 6732', ['SII', 6732.67e-4]),
